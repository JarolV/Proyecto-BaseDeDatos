...
public class ConsultasAbastecimiento extends javax.swing.JInternalFrame {

    public ConsultasAbastecimiento() {
        initComponents();
    ...
    void mostrartodosproductos()
    {
        ...
        String consulta= "SELECT cod_reabastecimiento,descripcion,cantidad FROM reabastecimiento";
        ...
        try {
            ...
            Logger.getLogger(ConsultasAbastecimiento.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// TODO add your handling code here:
    ...
    if(rbtndes.isSelected()==true)
    {
        ...
        tabla.setColumnIdentifiers(titulos);
        this.tbproductos.setModel(tabla);
        String consulta= "SELECT cod_reabastecimiento,descripcion,cantidad FROM reabastecimiento WHERE descripcion  LIKE '%"+buscar+"%'";
        String []Datos= new String [3];
        try {
            Statement st = cn.createStatement();
            ResultSet rs= st.executeQuery(consulta);
